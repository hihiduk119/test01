...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "3.4.2f3"; /* targetDevice = 2 */
	...
	void	createUnifeyeMobile();
	void	deleteUnifeyeMobile();
	void	render();
	void	setTrackingData();
	void	loadStandardCameraCalibration();
	void	getFrameSize();
...
void RegisterMonoModules()
{
...
#endif // !(TARGET_IPHONE_SIMULATOR)
	mono_dl_register_symbol("createUnifeyeMobile", (void*)&createUnifeyeMobile);
	mono_dl_register_symbol("deleteUnifeyeMobile", (void*)&deleteUnifeyeMobile);
	mono_dl_register_symbol("render", (void*)&render);
	mono_dl_register_symbol("setTrackingData", (void*)&setTrackingData);
	mono_dl_register_symbol("loadStandardCameraCalibration", (void*)&loadStandardCameraCalibration);
	...
	mono_dl_register_symbol("activateCamera", (void*)&activateCamera);
}
